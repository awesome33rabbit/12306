...
class Automatic_12306(object):
    def __init__(self, interface):
        ...
        self.seat_list = {'商务座特等座': 'TZ_', '一等座': 'ZY_', '二等座': 'ZE_', 'GR_': '高级软卧', '软卧一等座': 'RW_', '动卧': 'SRRB_',
        ...
        self.mail_user = "********@qq.com"  # 用户名
        self.mail_password = "********"  # 授权密码，非登录密码
        self.sender = '********@qq.com'  # 发件人邮箱(最好写全, 不然会失败)
        self.receivers = ['********@qq.com', ]  # 接收邮件，可设置为你的QQ邮箱或者其他邮箱
    ...
    def ticket_information(self,
        ...
        # self.to_station = '武汉'
        # self.train_date = "2019-03-01"
        # self.train_numbers = ["G1114", ]
        # self.seat_types = ['二等座', ]
        # self.passengers = ['***', ]  # 乘客姓名
    ...
    def login_input(self, username, password):
        ...
        userName.send_keys(username)  # 12306账号
        passWord = self.driver.find_element_by_id("J-password")
        passWord.send_keys(password)  # 12306密码
        time.sleep(0.5)
    ...
    def getVerifyResult(self):
        url = 'http://littlebigluo.qicp.net:47720/'  # 调用第三方图片识别接口
    ...
    def login(self):
        ...
        if status == 0:
            ...
            if status != 0:
                ...
                return
            elif status == 0 and self.interface == 0:
                ...
                if element:
                    for t in self.train_numbers:
                        ...
                        current_ge = self.driver.find_elements_by_xpath(
                            '//*[@datatran="' + t + '"]/preceding-sibling::tr[1]')
...
if __name__ == '__main__':
    ...
    buy = Automatic_12306(1)
    buy.login_input(username, password)
    buy.ticket_information(from_station,
                           to_station,
                           train_date,
                           train_numbers,
                           seat_types,
